...
main = do
  ...
  TransitGraphviz.writeToFile "graphs/door-with-alarm.dot" transit (_ { title = "Door with Alarm" })
  TransitTable.writeToFile "graphs/door-with-alarm.html" transit (_ { title = "Door with Alarm" })
