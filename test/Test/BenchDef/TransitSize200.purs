module Test.BenchDef.TransitSize200 where
...
type BenchTransit =
  Transit
    ...
    :* ("State180" :@ "Msg180" >| "State181")
    :* ("State181" :@ "Msg181" >| "State182")
    :* ("State182" :@ "Msg182" >| "State183")
    :* ("State183" :@ "Msg183" >| "State184")
    :* ("State184" :@ "Msg184" >| "State185")
    :* ("State185" :@ "Msg185" >| "State186")
    :* ("State186" :@ "Msg186" >| "State187")
    :* ("State187" :@ "Msg187" >| "State188")
    :* ("State188" :@ "Msg188" >| "State189")
    :* ("State189" :@ "Msg189" >| "State190")
    :* ("State190" :@ "Msg190" >| "State191")
    :* ("State191" :@ "Msg191" >| "State192")
    :* ("State192" :@ "Msg192" >| "State193")
    :* ("State193" :@ "Msg193" >| "State194")
    :* ("State194" :@ "Msg194" >| "State195")
    :* ("State195" :@ "Msg195" >| "State196")
    :* ("State196" :@ "Msg196" >| "State197")
    :* ("State197" :@ "Msg197" >| "State198")
    :* ("State198" :@ "Msg198" >| "State199")
    :* ("State199" :@ "Msg199" >| "State200")
    :* ("State200" :@ "Msg200" >| "State001")
...
update = mkUpdate @BenchTransit
  ...
  (match @"State180" @"Msg180" \_ _ -> return @"State181")
  (match @"State181" @"Msg181" \_ _ -> return @"State182")
  (match @"State182" @"Msg182" \_ _ -> return @"State183")
  (match @"State183" @"Msg183" \_ _ -> return @"State184")
  (match @"State184" @"Msg184" \_ _ -> return @"State185")
  (match @"State185" @"Msg185" \_ _ -> return @"State186")
  (match @"State186" @"Msg186" \_ _ -> return @"State187")
  (match @"State187" @"Msg187" \_ _ -> return @"State188")
  (match @"State188" @"Msg188" \_ _ -> return @"State189")
  (match @"State189" @"Msg189" \_ _ -> return @"State190")
  (match @"State190" @"Msg190" \_ _ -> return @"State191")
  (match @"State191" @"Msg191" \_ _ -> return @"State192")
  (match @"State192" @"Msg192" \_ _ -> return @"State193")
  (match @"State193" @"Msg193" \_ _ -> return @"State194")
  (match @"State194" @"Msg194" \_ _ -> return @"State195")
  (match @"State195" @"Msg195" \_ _ -> return @"State196")
  (match @"State196" @"Msg196" \_ _ -> return @"State197")
  (match @"State197" @"Msg197" \_ _ -> return @"State198")
  (match @"State198" @"Msg198" \_ _ -> return @"State199")
  (match @"State199" @"Msg199" \_ _ -> return @"State200")
  (match @"State200" @"Msg200" \_ _ -> return @"State001")
