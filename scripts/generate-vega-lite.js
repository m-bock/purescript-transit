 ...
 * Writes to: bench/compile-time/results.vl.json
 *
 * Format of input file (pipe-separated):
 *   moduleName|size|series|time_seconds
 *
 * Example:
 *   BenchSmall.Transit.Size020|20|update|2.235
 *   BenchSmall.Classic.Size020|20|updateClassic|1.623
 */

const fs = require("fs");
const path = require("path");

// Paths relative to project root (scripts/ is one level up from bench/)
